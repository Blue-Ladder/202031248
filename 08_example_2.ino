...
// change fadeValue according to dist_raw
  if(dist_raw< 200 && dist_raw >=100){
     fadeValue = 254 - 2.54*(dist_raw -100);
  }
  else  if(dist_raw>= 200 && dist_raw <=300){
     fadeValue = 2.54*(dist_raw -200);
  }
...
//output the fadeValue to the serial port
  Serial.print(",");
